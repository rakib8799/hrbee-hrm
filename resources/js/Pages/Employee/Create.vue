                ...
                <VForm @submit="submit()" class="form">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-5 g-4">
                            <!-- Email -->
                            <div class="col-md-6 fv-row">
                                <label class="required fs-5 fw-semibold mb-2">{{ $t('employee.label.email') }}</label>
                                <Field type="email" class="form-control form-control-lg form-control-solid" :placeholder="$t('employee.placeholder.email')" name="email" v-model="formData.email"/>
...
const submit = () => {
    if (props.branch?.id) {
        // for creating branch employee
        formData.post(route('branches.storeBranchEmployee', props.branch?.id), {
            preserveScroll: true,
        });
    } else {

    ...
    <AuthenticatedLayout :breadcrumbs="props?.breadcrumbs" :pageTitle="props?.pageTitle">
        ...
        <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
            ...
            <div class="card-body p-9">
                ...
                <!-- Mobile Number -->
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">{{ $t('employee.label.mobileNumber') }}</label>
                    <div class="col-lg-8">
        ...
        <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
            ...
            <div class="card-body p-9">
                ...
                <!-- Department Name -->
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">{{ $t('employee.label.departmentName') }}</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-900">{{ (props.employee?.department_id) == null ? '' : props.employee?.department.name }}</span>
                    </div>
                </div>

                <!-- Branch Name -->
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">{{ $t('employee.label.branchName') }}</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-900">{{ (props.employee?.branch_id) == null ? '' : props.employee?.branch.name }}</span>
                    </div>
                </div>

                <!-- Manager -->
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">{{ $t('employee.label.manager') }}</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-900">{{ (props.employee?.manager?.id && props.employee?.manager_id && props.employee?.manager?.id == props.employee?.manager_id)? (props.employee?.manager?.first_name + ' ' + props.employee?.manager?.last_name) : '' }}</span>
                    </div>
                </div>

                <!-- Leave Manager -->
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">{{ $t('employee.label.leaveManager') }}</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-900">{{ (props.employee?.leave_manager?.id && props.employee?.leave_manager_id && props.employee?.leave_manager?.id == props.employee?.leave_manager_id)? (props.employee?.leave_manager?.first_name + ' ' + props.employee?.leave_manager?.last_name) : '' }}</span>
                    </div>
                </div>

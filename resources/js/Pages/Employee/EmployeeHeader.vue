        ...
        <div class="card-body pt-9 pb-0">
            ...
            <div class="d-flex overflow-auto h-55px">
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-nowrap">
                    ...
                    <li class="nav-item" v-if="!props.employee?.is_departed && checkPermission('can-view-employee-attendance')">
                        <Link :href="route('attendance.index', props.id)" class="nav-link text-active-primary me-6"
                            :class="{ active: isActive('Attendance') }">{{ $t('employee.header.attendance.title') }}
                        </Link>
                    </li>
                    <li class="nav-item" v-if="!props.employee?.is_departed && checkPermission('can-view-attendance-log')">
                        <Link :href="route('attendance-log.index', props.id)" class="nav-link text-active-primary me-6"
                            :class="{ active: isActive('AttendanceLog') }">{{ $t('employee.header.attendanceLog.title') }}
                        </Link>
                    </li>
                    <li class="nav-item" v-if="props.employee?.is_departed && checkPermission('can-edit-employee')">

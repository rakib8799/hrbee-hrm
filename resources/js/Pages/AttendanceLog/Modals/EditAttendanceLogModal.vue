<template>
    <div class="modal fade" id="kt_modal_edit_attendance_log" ref="editAttendanceLogModalRef" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <!--begin::Modal header-->
                <div class="modal-header" id="kt_modal_edit_attendance_log_header">
                    <!--begin::Modal title-->
                    <h2 class="fw-bold">{{ $t('attendanceLog.header.edit') }}</h2>
                    <!--end::Modal title-->

                    <!--begin::Close-->
                    <div id="kt_modal_edit_attendance_log_close" data-bs-dismiss="modal" class="btn btn-icon btn-sm btn-active-icon-primary">
                ...
                <VForm @submit="submit()" :model="formData" ref="formRef">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <!--begin::Scroll-->
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_edit_attendance_log_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_edit_attendance_log_header" data-kt-scroll-wrappers="#kt_modal_edit_attendance_log_scroll" data-kt-scroll-offset="300px">
                            <!--Punch Type-->
                    ...
                    <div class="modal-footer flex-center">
                        <!--Discard Button-->
                        <button type="reset" id="kt_modal_edit_attendance_log_cancel" class="btn btn-light me-3">
...
const editAttendanceLogModalRef = ref < null | HTMLElement > (null);
...
const formData = useForm({
    ...
    punch_type: props.attendanceLog?.punchType || '',
    punch_time: props.attendanceLog?.punchTime || '',
    work_from: props.attendanceLog?.workFrom || ''
});

watch([() => props.attendanceLog?.punchType, () => props.attendanceLog?.punchTime, () => props.attendanceLog?.workFrom], ([punchType, punchTime, workFrom]) => {
    formData.punch_type = punchType || '';
    formData.punch_time = punchTime || '';
    formData.work_from = workFrom || '';
});
...
const submit = () => {
    const url = route('attendance-log.update', {
        employee: props.employee?.id,
        attendanceLog: props.attendanceLog?.id
    });
    formData.put(url, {
        preserveScroll: true,
        onSuccess: () => {
            hideModal(editAttendanceLogModalRef.value);

            ...
            <VForm @submit="submit()" class="form">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!-- Industry Name -->
                    <div class="fv-row mb-7">
                            <label class="fs-5 fw-semibold">{{ $t('configuration.label.industryName') }}</label>
                            <Field type="text" :placeholder="$t('configuration.placeholder.industryName')" name="industry" class="form-control form-control-lg form-control-solid" v-model="formData.industry"/>
                            <ErrorMessage :errorMessage="formData.errors.industry"/>
                        </div>
...
const formData = useForm({
    ...
    industry: props.configuration?.industry || '',

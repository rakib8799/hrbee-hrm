            ...
            <VForm @submit="submit()" class="form">
                ...
                <div class="card-body border-top p-9">
                    <div>
                        ...
                        <!-- Website -->
                        <div class="fv-row mb-7">
                            <label class="fs-5 fw-semibold">{{ $t('configuration.label.website') }}</label>
                            <Field type="text" class="form-control form-control-lg form-control-solid" :placeholder="$t('configuration.placeholder.website')" name="website"
                                    v-model="formData.website"/>
                            <ErrorMessage :errorMessage="formData.errors.website"/>
                        </div>
...
const formData = useForm({
    ...
    website: props.configuration?.website || '',

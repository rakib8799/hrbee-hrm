    ...
    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
        ...
        <div style="text-align:center; margin:0 15px 34px 15px">
            ...
            <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                <p style="margin-bottom:2px; color:#181C32; font-size: 22px; font-weight:700">Hey {{ $employee->first_name }} {{ $employee->last_name }}, </p>
                <p style="color:#50cd89; font-weight: bold;">
                    You are added as an employee. Now you need to verify your email.
                </p>
            </div>
            <!--end:Text-->
            <!--begin:Action-->
            <a href="{{ $resetPasswordLink }}" target="_blank" style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; text-decoration: none;">Reset Password</a>
            <!--begin:Action-->

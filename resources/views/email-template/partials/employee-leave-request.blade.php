    ...
    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
        ...
        <div style="text-align:center; margin:0 15px 34px 15px">
            ...
            <div style="font-size: 14px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                <p style="margin-bottom:2px; color:#181C32; font-size: 22px; font-weight:700">Hey {{ $user->name }}, </p>
                <p style="color:#F6C008; font-weight: bold;">
                    {{ $leaveRequest->employee->first_name }} {{ $leaveRequest->employee->last_name }} has requested you for the leave from {{ $leaveRequest->date_from }} - {{ $leaveRequest->date_to }}.
                </p>
            </div>
            <!--end:Text-->
            <!--begin:Action-->

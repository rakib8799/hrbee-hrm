...
class UpdateLeaveTypeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => 'required|string|unique:hr_leave_types,name,'.$leaveTypeId,
            'color' => 'required|string|unique:hr_leave_types,color,'.$leaveTypeId,
            'sequence' => 'required|numeric|unique:hr_leave_types,sequence,'.$leaveTypeId,

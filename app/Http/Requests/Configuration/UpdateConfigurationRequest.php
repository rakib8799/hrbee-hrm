...
class UpdateConfigurationRequest extends FormRequest
{
    ...
    private function validateTimezone($attribute, $value, $fail)
    {
        $timezone = Timezone::find($value);
        if ($value!= NULL && !$timezone) {
            $fail(__('validation.custom.configuration.timezone_id.exists'));
        }
    }

...
class ConfigurationController extends Controller
{
    ...
    public function syncConfigurations(Request $request)
    {
        $validatedData = $request->all();
        $this->configurationService->updateConfiguration($validatedData);
        return response()->json(['message' => 'Configuration synced successfully']);
    }
}

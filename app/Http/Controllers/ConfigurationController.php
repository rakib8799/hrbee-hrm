...
class ConfigurationController extends Controller implements HasMiddleware
{
    ...
    public function __construct(ConfigurationService $configurationService, CountryService $countryService, LanguageService $languageService, TimezoneService $timezoneService)
    {
    ...
    public function additionalInfo()
    {
        ...
        $languages = $this->languageService->getLanguages();
        $timezones = $this->timezoneService->getActiveTimezones();
        $dateFormats = HelperService::getDateFormats();
        $weekDays = HelperService::getWeekDays();
        $responseData = [
            'languages' => $languages,
            'timezones' => $timezones,

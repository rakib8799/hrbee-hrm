...
//     // Handle the 'updated' event dynamically
//     if ($eventName === 'updated') {
//         $description = "Updated the employee: " . $this->getFullName();

//         // Check if there are any dirty fields (fields that were changed)
//         if ($this->getDirty()) {
//             // Loop through all dirty attributes and create dynamic descriptions
//             foreach ($this->getDirty() as $attribute => $newValue) {
//                 // Map attributes to readable field names (optional but can improve clarity)
//                 $fieldLabels = [
//                     'is_active' => 'Status',
//                     'job_title' => 'Job title',
//                     'salary' => 'Salary',
...
//                 // Get human-readable field label, defaulting to the attribute name if not found
//                 $fieldLabel = $fieldLabels[$attribute] ?? ucfirst(str_replace('_', ' ', $attribute));

//                 // Generate a dynamic log description based on the changed field
//                 if ($attribute === 'department_id') {
//                     // Assuming you have a relationship `department` on the User model
//                     $newValue = $this->department->name ?? 'Unknown Department';
//                 }

//                 // Append the field change to the description
//                 $description .= " - {$fieldLabel} changed to: {$newValue}.";
//             }
//         }
